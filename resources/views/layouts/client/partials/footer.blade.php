<div class="container-fluid bg-[#2d314d] py-12 text-center md:px-48">
    <div class="grid grid-cols-1 xl:grid-cols-4">
        <div class="mx-auto xl:mx-0">
            <a href="{{ route('client-panel') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Kosaya</span>
            </a>
            <div class="flex mt-5 mb-5 xl:mt-10 xl:mb-0">
                <!-- hover facebook -->
                <a href="#" class="pr-3">
        ...
        <div class="text-white text-sm">
            <a href="#" class="hover:text-[#41C9E2]">About Us</a>
            <a href="#" class="hover:text-[#41C9E2]">
        ...
        <div class="text-white text-sm">
            <a href="#" class="hover:text-[#41C9E2]">Careers</a>
            <a href="#" class="mt-3 hover:text-[#41C9E2]">
        ...
        <div class="text-center xl:text-end mt-5">
            @if (Route::has('login'))
                <div class="sm:top-0 sm:right-0 text-center md:text-right">
                    @auth
                        <a href="@if (Auth::user()->role == 'Admin') {{ route('admin-panel') }} @elseif (Auth::user()->role == 'Owner') {{ route('owner-panel') }} @elseif (Auth::user()->role == 'Client') {{ route('client-panel') }} @endif"
