...
@section('main-content')
    <div class="banner text-center relative">
        <div class="flex flex-col absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <p class="font-bold text-3xl md:text-4xl lg:text-5xl tracking-[0.2rem] text-white mb-10">
                CARI KOS SESUAI KEINGINANMU</p>

            <form action="{{ route('search-kost') }}" class="w-full mx-auto" method="GET">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search"
                        ...
                        placeholder="Cari Kos Idamanmu..." name="search_kost" value="{{ request('search_kost') }}" />
                    <button type="submit"
    ...
    <div class="container mx-auto text-center my-28">
        <p class="text-2xl font-bold md:tracking-[0.2rem]">KOS - KOS YANG BISA KAMU JELAJAHI</p>
