<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Hp -->
        <div>
            <x-input-label for="hp" :value="__('Hp')" class="mt-2" />
        ...
        <!-- Alamat -->
        <div>
            <x-input-label for="alamat" :value="__('Address')" class="mt-2" />
        ...
        {{-- Role --}}
        <div>
            <x-input-label for="role" :value="__('This account as')" class="mt-2" />
