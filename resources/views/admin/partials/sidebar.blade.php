<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @if (Auth::guard()->user()->role == 'Admin')
            <li class="menu-item {{ $page == 'dashboard-admin' ? 'active' : '' }}">
            ...
            <li class="menu-item {{ $page == 'kost' ? 'active' : '' }}">
                <a href="{{ route('kost-show') }}" class="menu-link">
            ...
            <li class="menu-item {{ $page == 'room' ? 'active' : '' }}">
                <a href="{{ route('room-show') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-grid bx-tada-hover"></i>
        ...
        @elseif (Auth::guard()->user()->role == 'Owner')
            <li class="menu-item {{ $page == 'dashboard-owner' ? 'active' : '' }}">
                <a href="{{ route('owner-panel') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-home-circle bx-tada-hover"></i>
                    <div data-i18n="Email">Dashboard</div>
                </a>
            </li>
            <li class="menu-item {{ $page == 'kost-owner' ? 'active' : '' }}">
                <a href="{{ route('kostOwner-show') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-buildings bx-tada-hover"></i>
                    <div data-i18n="Chat">Kost</div>
                </a>
            </li>
