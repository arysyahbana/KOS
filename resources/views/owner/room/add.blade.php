...
@section('title', 'Add Room-Owner')

@section('main-content')
    <div class="container flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Kosts /</span> Add Room</h4>
        <div class="card mb-4">
                ...
                <form action="{{ route('roomOwner-store') }}" id="formAccountSettings" method="POST"
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <select id="status" class="select2 form-select" name="kost_id">
